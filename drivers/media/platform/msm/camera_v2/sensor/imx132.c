...
#if defined(CONFIG_MACH_LYNX_DL40) || defined(CONFIG_MACH_LYNX_DL50) || defined(CONFIG_MACH_LYNX_GP9D) || defined(CONFIG_MACH_LYNX_DL60) 
	{
		.seq_type = SENSOR_CLK,
...
#if defined(CONFIG_MACH_LYNX_DL40) || defined(CONFIG_MACH_LYNX_DL50) || defined(CONFIG_MACH_LYNX_DL60)
			fps = 151648352 /
				fl_lines / ll_pclk;
#else
			fps = 142736842 /
